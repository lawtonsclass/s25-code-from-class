...
0000000000001149 <main>:
    ...
    1155:	89 7d fc             	mov    DWORD PTR [rbp-0x4],edi # argc
    ...
    1164:	48 8b 00             	mov    rax,QWORD PTR [rax] # rax = *rax (argv[1])
    1167:	48 83 c0 03          	add    rax,0x3 # (addr of the char 4 in argv[1])
    116b:	0f b6 00             	movzx  eax,BYTE PTR [rax] # eax = *rax; (eax = 4th char of argv[1])
    ...
    117c:	e8 cf fe ff ff       	call   1050 <puts@plt> # printing string 2004 (access granted)
    1181:	eb 0f                	jmp    1192 <main+0x49>
    1183:	48 8d 05 89 0e 00 00 	lea    rax,[rip+0xe89] # beginning of else       # 2013 <_IO_stdin_used+0x13>
    118a:	48 89 c7             	mov    rdi,rax
    118d:	e8 be fe ff ff       	call   1050 <puts@plt> # print string 2013
